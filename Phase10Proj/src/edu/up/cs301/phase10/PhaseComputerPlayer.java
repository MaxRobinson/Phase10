...
public class PhaseComputerPlayer extends GameComputerPlayer
{
	...
	private PhaseState savedState;
	
    /**
     * Constructor for the PhaseComputerPlayer class; creates an "average"
     * player.
     * 
     * @param name
     * 		the player's name
    ...
    /*
     * Constructor for the PhaseComputerPlayer class
     */
    public PhaseComputerPlayer(String name, double avgReactionTime) {
    ...
    protected void timerTicked() {
    	...
    	if (topCard != null && topCard.getRank() == Rank.JACK) {
    		...
    		game.sendAction(new PhaseSlapAction(this));
    	}
    ...
    protected void receiveInfo(GameInfo info) {
    	...
    	if (topCard != null && topCard.getRank() == Rank.JACK) {
        	...
        	game.sendAction(new PhasePlayAction(this));
    	}
    }
}
